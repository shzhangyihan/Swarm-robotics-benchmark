...
void setup() {
    ...
    subscriber_channel_1 = channel_seed_1->new_subscriber(260, recv_callback_channel_1);
    subscriber_channel_2 = channel_seed_2->new_subscriber(260, recv_callback_channel_2);
